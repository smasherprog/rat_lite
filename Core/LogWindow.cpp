...
SL::Remote_Access_Library::Server::UI::LogWindow::LogWindow()
{
...
void SL::Remote_Access_Library::Server::UI::LogWindow::Show()
{
	_LogWindowImpl->Show();
}


void SL::Remote_Access_Library::Server::UI::LogWindow::Hide()
{
	_LogWindowImpl->Hide();
}

void SL::Remote_Access_Library::Server::UI::LogWindow::AddMessage(std::string msg)
{
	_LogWindowImpl->AddMessage(msg);
}
void SL::Remote_Access_Library::Server::UI::LogWindow::set_MaxLines(int lines)
{
