	...
	namespace Remote_Access_Library {
		...
		namespace Server {
			...
			public:
				...
				RA_Server(std::shared_ptr<Network::Server_Config> config, Network::IBaseNetworkDriver<std::shared_ptr<Network::ISocket>, std::shared_ptr<Network::Packet>>* parent = nullptr);
				~RA_Server();
