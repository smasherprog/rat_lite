...
namespace SL {
	namespace Remote_Access_Library {
		namespace Utilities {
			...
			inline  std::ostream& operator<<(std::ostream& os, const SL::Remote_Access_Library::Utilities::Point& p)
			{
				os << "X=" << p.X << ", Y=" << p.Y;
				return os;
			}
			inline  std::ostream& operator<<(std::ostream& os, const SL::Remote_Access_Library::Utilities::Rect& r)
			{
